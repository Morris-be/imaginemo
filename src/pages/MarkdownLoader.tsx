      ...
      <div className="content-width-resp w-full p-5 items-center mx-auto text-body-resp">
        <ReactMarkdown
          ...
          components={{
            ...
            li: ({ children }) => <li className="ml-4 list-disc text-body-resp mb-2">{children}</li>,
            ...
            a: ({ children, href, ...props }) => {
              ...
              return (
                <a href={href} className="custom-link-styling" target="_blank" rel="noopener noreferrer" {...props}>
                  {children}
                </a>
              );
            },
